...
sys.path.append("C:\\Users\\Jason\\Desktop\\UnrealAirSimDRL-master\\Deep_Reinforcement_Learning\\Library")
from CRDQN import CRDQN
from CDQN import CDQN
sys.path.append("C:\\Users\\Jason\\Desktop\\UnrealAirSimDRL-master\\Deep_Reinforcement_Learning\\Library\\ClientAirSimEnvironments")
...
def main():
    ...
    model_dir = "C:\\Users\\Jason\\Desktop\\UnrealAirSimDRL-master\\Deep_Reinforcement_Learning\\Projects\\Car\\Data"
    ...
    primaryNetwork = CRDQN(xdims, n_outputs, hidden_layer_sizes, 
                 gamma, learning_rate = learning_rate, batch_sz = trainig_batch_size, name = "primaryNetwork")
    
    targetNetwork = CRDQN(xdims, n_outputs, hidden_layer_sizes, 
                  gamma, learning_rate = learning_rate, batch_sz = trainig_batch_size, name = "targetNetwork")
